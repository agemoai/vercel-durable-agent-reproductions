...
export const flightBookingTools = {
  ...
  // This tool call will be streamed back to the client and resolved
  // via the onToolCall callback in useChat's addToolOutput.
  getUserLocation: {
    description:
      "Get the user's current location from the browser. Use this when the user asks about flights near them or from their current location.",
    inputSchema: z.object({}),
  },
};
